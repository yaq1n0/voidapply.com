...
export const engineeringJobs: Job[] = [
  {
    ...
    rejectionContent: {
      "fake-email": {
        subject:
          "Update on your application for Senior Frontend Engineer at Google",
        body: `Dear Applicant,
...
*File will be deleted in 5... 4... 3...`,
        ...
        categories: [
          {
            ...
            score: 12,
            comment:
              'Did not mention "synergy" or "leverage" once. Deeply concerning.',
          },
          {
            name: "Years of Experience vs. Technology Age",
            score: 3,
            comment:
              "Claims 8 years of React. We need 15. React is 11 years old. Not our problem.",
          },
          {
            name: "Enthusiasm for Free Snacks",
            score: 0,
            comment:
              "Failed to mention Google's snack program even once. CRITICAL FAILURE.",
          },
          {
            name: "Whiteboard Problem Solving",
            score: 5,
            comment:
              "Resume did not include a hand-drawn binary tree. Automatic penalty.",
          },
          {
            name: "Cultural Fit Score",
            score: 15,
            comment:
              'Used the word "innovative" but not "Googley." Insufficient brand alignment.',
          },
        ],
      },
    },
  },
  {
    ...
    rejectionContent: {
      "fake-email": {
        subject:
          "Your application to Google — Software Engineer, Backend Systems",
        body: `Hi there,
...
(This is an automated message. Please do not reply. We wouldn't read it anyway.)`,
  ...
  },
  {
    ...
    rejectionContent: {
      "fake-email": {
        subject:
          "Regarding your application — Software Development Engineer II at Amazon",
        body: `Dear Candidate,
      ...
      "ats-score": {
        ...
        categories: [
          ...
          },
          {
            ...
            score: 5,
            comment:
              'Resume mentions "years of experience." That\'s Day 2 thinking.',
          },
        ],
      },
    },
